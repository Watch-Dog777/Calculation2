...
public class Main2Activity_4 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (showString.equals("")) {
            ...
            editTextMain.setText(showString);
            AreaInt = Integer.parseInt(showString) * Areafloat;
            editText1_1.setText(Double.toString(AreaInt));
        }
    }
}
