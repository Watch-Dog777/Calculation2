...
public class Main2Activity_9 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_9);
    ...
    public void onClick(View v) {
        ...
        if (showString.equals("")) {
            ...
            editTextMain.setText(showString);
            WeightInt = Integer.parseInt(showString) * Weightfloat;
            editText1_1.setText(Double.toString(WeightInt));
        }
    }
}
