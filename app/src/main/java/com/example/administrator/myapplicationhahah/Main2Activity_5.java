...
public class Main2Activity_5 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (showString.equals("")) {
            ...
            editTextMain.setText(showString);
            MassInt = Integer.parseInt(showString) * Massfloat;
            editText1_1.setText(Double.toString(MassInt));
        }
    }
}
