...
public class Main2Activity_3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b0,bp,bpp;
    EditText editTextMain,editText1_1;
    double LengthInt = 0;
    double Lengthfloat = 0;
    String Name;
    int tempa;
    ...
    public void onClick(View v) {
        ...
        if (showString.equals("")) {
            ...
            editTextMain.setText(showString);
            LengthInt = Integer.parseInt(showString) * Lengthfloat;
            editText1_1.setText(Double.toString(LengthInt));
        }
    }
}
