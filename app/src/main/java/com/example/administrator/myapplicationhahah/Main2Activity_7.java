...
public class Main2Activity_7 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    public void whereis(int position){
        switch (position){
            ...
            case 2:
                ...
                break;
            case 3:
                Batfloat = 0.277777778;
                break;
            case 4:
                Batfloat = 0.514444444;
                break;
    ...
    public void onClick(View v) {
        ...
        if (showString.equals("")) {
            ...
            editTextMain.setText(showString);
            BatInt = Integer.parseInt(showString) * Batfloat;
            editText1_1.setText(Double.toString(BatInt));
        }
    }
}
