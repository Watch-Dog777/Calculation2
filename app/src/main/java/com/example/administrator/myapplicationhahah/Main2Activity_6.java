...
public class Main2Activity_6 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_6);
    ...
    public void onClick(View v) {
        ...
        if (showString.equals("")) {
            ...
            editTextMain.setText(showString);
            HeatInt = Integer.parseInt(showString) * Heatfloat;
            editText1_1.setText(Double.toString(HeatInt));
        }
    }
}
